...
<div class="w3-panel w3-card-4 w3-light-grey">
	...
	<div class="w3-row-padding">
		<div class="w3-col m12">
			...
			<?php
				echo $this->job_requisition->read_job_dtl_list_not_accept_html();
			?>
			</div>	
		</div>
	</div>	
...
<script type="text/javascript">
    ...
    function update_Acc_Rej(jobno, status){
		...
		var engineer_id = '#id_engineer_' + jobno;
		var estimate_date_id = '#idestimate_date_' + jobno;

		var _engineer = $(engineer_id).val();
		var _estimatedatecomplete = get_json_date($(estimate_date_id).val()); 		

		_ReqHdrData[0] = { "jobno": _jobno, "docstatus": _docstatus, "apprejremarks": _apprejremarks, "insertuser": _insertuser, "engineer": _engineer, "estimatedatecomplete": _estimatedatecomplete };

		var ReqHdrData = JSON.stringify(_ReqHdrData);

        //alert(ReqHdrData);

		<?php echo "var url = '". base_url()."index.php/transaction/acceptjob';"; ?>
