...
<div class="w3-panel w3-card-4 w3-light-grey">
	...
	<div class="w3-row-padding">
		<div class="w3-col m12">
			...
			<?php
				echo $this->job_requisition->read_job_dtl_list_not_feedback_html();
			?>
			</div>	
		</div>
	</div>	
...
<script type="text/javascript">
    ...
    function feedback_ok_no(jobno, status){
		...
		_ReqHdrData[0] = { "jobno": _jobno, "docstatus": _docstatus, "apprejremarks": _apprejremarks, "insertuser": _insertuser };

		var ReqHdrData = JSON.stringify(_ReqHdrData);

        //alert(ReqHdrData);

		<?php echo "var url = '". base_url()."index.php/transaction/feedbackjob';"; ?>
