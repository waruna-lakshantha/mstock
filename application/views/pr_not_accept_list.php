...
<div class="w3-panel w3-card-4 w3-light-grey">
	...
	<div class="w3-row-padding">
		<div class="w3-col m12">
			...
			<?php
				echo $this->pr->read_pr_for_accept_html($prtype);
			?>
			</div>	
		</div>
	</div>	
...
<script type="text/javascript">
    ...
    function update_Acc_Rej(prno, status){
    	
    	var up_btn_id = '#idupdateapp_' + prno;
        ...
        var freetxt_id = '#id_freetxt_' + prno;
    	var _apprejremarks = $(freetxt_id).val();
		var _insertuser = '<?php echo $this->session->userdata['logged_in']['username'];?>';

		_ReqHdrData[0] = { "prno": _prno, "docstatus": _docstatus, "apprejremarks": _apprejremarks, "insertuser": _insertuser };

		var ReqHdrData = JSON.stringify(_ReqHdrData);

		<?php echo "var url = '". base_url()."index.php/transaction/acceptpr';"; ?>
