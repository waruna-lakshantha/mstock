...
$rpt_det = $this->grn->read_grn_list_report($date_para, $com_para, $dept_para, $item_para, $status_para);
...
<body>
    ...
    <table style="width: 8.5in;">
        ...
        <tr>
            <td style="text-align: center;"><b>GRN List</b></td>
        </tr>
        <tr>
        ...
        <?php
        	...
        	{	
        		echo "<tr>";
	        		...
	        		echo "<td width=\"10%\">".$row_dtl->grnno."</td>";
        			...
        			echo "<td width=\"10%\">".$row_dtl->name."</td>";
        			echo "<td width=\"5%\">".$row_dtl->pono."</td>";
