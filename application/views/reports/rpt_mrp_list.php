<?php
	...
	$pr_det = $this->pr->read_pr_list_report($date_para, $com_para, $dept_para, $item_para, $status_para, $machine_para);
...
<body>
    ...
    <table style="width: 8.5in;">
        ...
        <tr>
            <td style="text-align: center;"><b>MRP List</b></td>
        </tr>
        <tr>
        ...
        <?php
        	...
        	{	
        		echo "<tr>";
        			...
        			echo "<td width=\"10%\">".$row_dtl->prno."</td>";
        			...
        			echo "<td width=\"10%\">".$row_dtl->date."</td>";
        			echo "<td width=\"10%\">".$row_dtl->reqdate."</td>";
