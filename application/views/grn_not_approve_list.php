...
<div class="w3-panel w3-card-4 w3-light-grey">
	...
	<div class="w3-row-padding">
		<div class="w3-col m12">
			...
			<?php
				echo $this->grn->read_grn_for_approval_html();
			?>
			</div>	
		</div>
	</div>	
...
<script type="text/javascript">
    ...
    function update_App_Rej(jobno, status){

        //alert(jobno);
        
        var up_btn_id = '#idupdateapp_' + jobno;
		...
		_ReqHdrData[0] = { "no": _jobno, "docstatus": _docstatus, "apprejremarks": _apprejremarks, "insertuser": _insertuser };

		var ReqHdrData = JSON.stringify(_ReqHdrData);

        //alert(ReqHdrData);

		<?php echo "var url = '". base_url()."index.php/transaction/approvegrn';"; ?>
