<?php
	...
	$pr_hdr = $this->min->read_min_hdr_by_minno($docno);
...
<head>
	...
	<meta charset="utf-8">
	<title>MIN - <?php echo $min_no;?></title>
...
<body>
    ...
    <table style="width: 8.5in;">
        ...
        <tr>
            <td style="text-align: center;"><b>Material Issued Note</b><hr></td>
        </tr>
    ...
    <table style="width: 8.5in;">           
        <tr>
            <td width="10%">MIN No</td>
            <td width="5%">:</td>
            <td width="15%"><?php echo $min_no;?></td>
            <td width="10%">Issued By</td>
            <td width="5%">:</td>
	...
	<table class="bdr" style="width: 8.5in;">
        ...
        <?php 
        	...
        	$pr_dtl = $this->min->read_min_dtl_by_no($docno);
        	...
        	{	
        		...
        		echo "<td width=\"5%\">".$row_dtl->itemcode."</td>";
	        		...
	        		echo "<td width=\"5%\">".$row_dtl->mrno."</th>";
	        		echo "<td width=\"10%\">".$row_dtl->Company."</d>";
	        		echo "<td width=\"10%\">".$row_dtl->Department."</td>";
	        		echo "<td width=\"10%\">".$row_dtl->Machine."</td>";
